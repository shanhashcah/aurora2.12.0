...
func (e HcnetValueType) EncodeTo(enc *xdr.Encoder) error {
	if _, ok := hcnetValueTypeMap[int32(e)]; !ok {
		return fmt.Errorf("'%d' is not a valid HcnetValueType enum value", e)
	}
	_, err := enc.EncodeInt(int32(e))
	return err
}

var _ decoderFrom = (*HcnetValueType)(nil)

// DecodeFrom decodes this value using the Decoder.
func (e *HcnetValueType) DecodeFrom(d *xdr.Decoder) (int, error) {
	v, n, err := d.DecodeInt()
	if err != nil {
		return n, fmt.Errorf("decoding HcnetValueType: %s", err)
	}
	if _, ok := hcnetValueTypeMap[v]; !ok {
		return n, fmt.Errorf("'%d' is not a valid HcnetValueType enum value", v)
	}
	*e = HcnetValueType(v)
	return n, nil
}
...
// xdrType signals that this type is an type representing
// representing XDR values defined by this package.
func (s HcnetValueType) xdrType() {}

var _ xdrType = (*HcnetValueType)(nil)
...
func (u HcnetValueExt) ArmForSwitch(sw int32) (string, bool) {
	switch HcnetValueType(sw) {
	case HcnetValueTypeHcnetValueBasic:
		return "", true
	case HcnetValueTypeHcnetValueSigned:
...
func (u HcnetValueExt) EncodeTo(e *xdr.Encoder) error {
	...
	return fmt.Errorf("V (HcnetValueType) switch value '%d' is not valid for union HcnetValueExt", u.V)
}

var _ decoderFrom = (*HcnetValueExt)(nil)

// DecodeFrom decodes this value using the Decoder.
func (u *HcnetValueExt) DecodeFrom(d *xdr.Decoder) (int, error) {
	var err error
	var n, nTmp int
	...
	return n, fmt.Errorf("union HcnetValueExt has invalid V (HcnetValueType) switch value '%d'", u.V)
}
...
// xdrType signals that this type is an type representing
// representing XDR values defined by this package.
func (s HcnetValueExt) xdrType() {}

var _ xdrType = (*HcnetValueExt)(nil)
...
var _ decoderFrom = (*HcnetValue)(nil)

// DecodeFrom decodes this value using the Decoder.
func (s *HcnetValue) DecodeFrom(d *xdr.Decoder) (int, error) {
	var err error
	var n, nTmp int
	...
	n += nTmp
	if err != nil {
		return n, fmt.Errorf("decoding HcnetValueExt: %s", err)
	}
	return n, nil
}
...
// xdrType signals that this type is an type representing
// representing XDR values defined by this package.
func (s HcnetValue) xdrType() {}

var _ xdrType = (*HcnetValue)(nil)
...
func (s *LedgerHeader) DecodeFrom(d *xdr.Decoder) (int, error) {
	...
	n += nTmp
	if err != nil {
		return n, fmt.Errorf("decoding HcnetValue: %s", err)
	}
...
func (u HcnetMessage) EncodeTo(e *xdr.Encoder) error {
	...
	return fmt.Errorf("Type (MessageType) switch value '%d' is not valid for union HcnetMessage", u.Type)
}

var _ decoderFrom = (*HcnetMessage)(nil)

// DecodeFrom decodes this value using the Decoder.
func (u *HcnetMessage) DecodeFrom(d *xdr.Decoder) (int, error) {
	var err error
	var n, nTmp int
	nTmp, err = u.Type.DecodeFrom(d)
	n += nTmp
	...
	return n, fmt.Errorf("union HcnetMessage has invalid Type (MessageType) switch value '%d'", u.Type)
}
...
// xdrType signals that this type is an type representing
// representing XDR values defined by this package.
func (s HcnetMessage) xdrType() {}

var _ xdrType = (*HcnetMessage)(nil)
...
func (s *AuthenticatedMessageV0) DecodeFrom(d *xdr.Decoder) (int, error) {
	...
	n += nTmp
	if err != nil {
		return n, fmt.Errorf("decoding HcnetMessage: %s", err)
	}
